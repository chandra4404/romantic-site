...
// 🌸 IMAGE ANIMATION (fixed scaling for mobile)
tl.to(".center-image img", {
  duration: 2,
  opacity: 2,
  scale: isMobile ? 1 : 1.2,   // no oversized image on mobile
  y: isMobile ? 10 : 20,
  ease: "power2.out"
}, "flower3+=1");
...
const particleInterval = isMobile ? 700 : 400;   // slower on mobile
...
setInterval(() => {
  ...
  // shorter + smoother animation for mobile
